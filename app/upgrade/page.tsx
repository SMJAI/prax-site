    ...
    <>
      ...
      <div className="pricing-grid">
        <div className="pricing-card">
          ...
          <a 
            href={`https://praxdigital.lemonsqueezy.com/checkout/buy/625a0310-d89e-431f-85d2-cbb3a1a2ecec?checkout[email]=${encodeURIComponent(userEmail)}`} 
        ...
        <div className="pricing-card featured">
          ...
          <a 
            href={`https://praxdigital.lemonsqueezy.com/checkout/buy/15eeba33-3d0d-45a4-898b-998cefce0157?checkout[email]=${encodeURIComponent(userEmail)}`} 
        ...
        <div className="pricing-card">
          ...
          <a 
            href={`https://praxdigital.lemonsqueezy.com/checkout/buy/557bd908-945f-4dd3-bbc0-e701df7303b9?checkout[email]=${encodeURIComponent(userEmail)}`} 
            className="pricing-btn pricing-btn-secondary"
          >
            Start Monthly
          </a>
